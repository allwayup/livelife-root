...
public class Generic {
    ...
    private Generic(Class<?> mainClass) {
        this.mainClass = mainClass;
        classGeneric();
    }

    private Generic(Field field) {
        this.field = field;
        classGeneric();
    }

    private Generic(String className) {
        this.className = className;
        genericClass();
    }

    public static Generic create(Class<?> mainClass) {
        return new Generic(mainClass);
    }

    public static Generic create(Field field) {
        return new Generic(field);
    }

    public static Generic create(String className) {
    ...
    public Generic getGeneric() {
        ...
        return Generic.create(genericStr(this.className));
    }
